...
// An unmeasurable filesystem must yield NO flags - better to fall back to the age filter alone than to invent a ceiling out of a failed statfs and prune somebody's cache on the strength of it.
